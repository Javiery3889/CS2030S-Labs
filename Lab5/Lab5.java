 ...
 * 
 * <p>
 * Uses nested Map layers to store information about modules, students and assessments.
 *</p>
 *
...
class Lab5 {
  public static String getGrade(String module, String student, String assessment,
    ...
    Constant<Actually<Map<String, Map<String, Map<String, String>>>>> constDb = new Constant<>() {
      @Override
    ...
    Constant<String> constEmpty = new Constant<>() {
      @Override
      public String init() {
    ...
    Immutator<Actually<Map<String, Map<String, String>>>, Map<String, Map<String, 
        Map<String, String>>>> getModule = new Immutator<>() {
          @Override
          public Actually<Map<String, Map<String, String>>> invoke(Map<String, 
              Map<String, Map<String, String>>> m) {
                return Actually.ok(m.get(module));
          }
        };

    Immutator<Actually<Map<String, String>>, Map<String, 
        Map<String, String>>> getStudent = new Immutator<>() {
          @Override
    ...
    return constDb.init().next(getModule).next(getStudent).next(getAssessment).except(constEmpty);
  }
